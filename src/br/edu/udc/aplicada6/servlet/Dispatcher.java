package br.edu.udc.aplicada6.servlet;
...
import br.edu.udc.aplicada6.controller.Controller;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			if ((action != null) && (!action.trim().equals("")) &&
				...
				Class <?> controllerClass = Class.forName("br.edu.udc.aplicada6.controller.Controller" + entityName);
